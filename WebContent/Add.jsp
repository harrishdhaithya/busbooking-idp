...
<%@ page import="com.controllers.Helper,com.controllers.User,com.controllers.bus,java.util.*" %>
<%
	String message = "";
	if(request.getParameter("createBus") != null){
		bus trn = new bus();
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 text-center">
				<div class="rs_btn_group">
					<button class="btn btn-default pull-left" name="createBus" value="submit" type="submit">Save</button>
				</div>
			</div>
		</div>
	</form>
