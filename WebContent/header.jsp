...
<%@ page import="com.controllers.Helper,com.controllers.User" %>
<%
  	...
  	<div class="header">
  		<div class="container">
  			<div class="header_content ">
  				IDP Phase II - Online Bus Ticket Booking System
  			</div>
  			<div class="main_nav">
  				<ul class="nav nav-pills pull-left">
  					<% if(isLogin){ 
  						...
  						if(user.rule.equals("admin")){
							...
							<li  class="nav-item"><a href="<%= Helper.baseUrl %>Destinations.jsp" class="nav-link">Journeys</a></li>
