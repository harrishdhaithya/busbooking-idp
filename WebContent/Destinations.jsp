...
<%@page import="com.model.*,com.controllers.*,java.util.ArrayList,java.util.Iterator,java.util.HashMap" %>
<%
...
buslist = trn.getAll();
Iterator<Bus> trnIt = buslist.iterator();
		...
		<div class="rs_box" style="overflow:auto;">
			...
			<table id="data_list_item" style="display:none;">
					...
					<tr>
						...
						<td>
							<div class="input-group">
								<input class="form-contoller" name="jurny_time[]" type="datetime-local">
							</div>
						</td>
						<td>
							<div class="input-group">
