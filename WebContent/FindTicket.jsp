...
<%
	...
	if (totalSeat != null && date != null && destination != null) {
		session.setAttribute("totalSeat", totalSeat);
	...
	if(totalSeat != null && date != null && destination != null && actionType.equals("search")){
		...
		<div class="ticket_info">
			...
			<table class="table">
				<tr>
					...
					<td>
						<ul>
							<li><strong>Bus/Name</strong> <span><%= tickDetails.get("bus_name") %></span></li>
		...
		<div class="ticket_info">
			...
			<a href="PrintTicket2.jsp">Print</a>
		</div>
